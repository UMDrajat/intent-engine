...
def run_demo_service():
    ...
    from app.demos.demo_service import demo_service_recommendation
...
def run_demo_ad():
    ...
    from app.demos.demo_ad import demo_ad_matching
...
def run_demo_ranking():
    ...
    from app.demos.demo_ranking import demo_ranking
...
def run_perf_tests():
    ...
    from app.perf_tests.perf_test_ranker import test_performance as test_ranker_perf

    print("Testing Intent Ranker Performance:")
    test_ranker_perf()
    print()

    from app.perf_tests.perf_test_service import test_performance as test_service_perf

    print("Testing Service Recommender Performance:")
    test_service_perf()
    print()

    from app.perf_tests.perf_test_ad import test_performance as test_ad_perf
