...
async def test_result_aggregator():
    ...
    from app.searxng.query_router import SearchBackend, SearchResult
    from app.searxng.result_aggregator import get_result_aggregator
...
async def test_unified_search_service():
    ...
    try:
        from app.models import UnifiedSearchRequest
        from app.searxng.query_router import get_query_router
...
async def test_web_intent_extractor():
    ...
    from app.extraction.web_extractor import get_web_intent_extractor
