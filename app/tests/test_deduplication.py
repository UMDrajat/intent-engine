...
class TestDeduplication(unittest.TestCase):
    ...
    def test_simhash_logic(self):
        ...
        self.assertLess(dist_1_2, 10, "Near-duplicates should have low Hamming distance")
        self.assertGreater(dist_1_3, 15, "Different texts should have high Hamming distance")
    ...
    def test_simhash_sensitivity(self):
        ...
        self.assertLessEqual(hamming_distance(h1, h2), 2, "Small punctuation changes should result in very low distance")
