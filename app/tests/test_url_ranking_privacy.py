...
class TestURLRankingPrivacy(unittest.TestCase):
    def test_privacy_scores(self):
        ...
        self.assertGreaterEqual(
            PrivacyDatabase.get_privacy_score("protonmail.com"), 0.9
        )
        self.assertGreaterEqual(
            PrivacyDatabase.get_privacy_score("duckduckgo.com"), 0.9
        )
        ...
        self.assertGreaterEqual(
            PrivacyDatabase.get_privacy_score("api.protonvpn.com"), 0.9
        )

        # Unknown domains should be 0.5
        self.assertEqual(
            PrivacyDatabase.get_privacy_score("some-random-new-domain.com"), 0.5
        )
