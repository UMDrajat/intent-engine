...
[![Version](https://img.shields.io/badge/version-2.2.0-blue.svg)](https://github.com/itxLikhith/intent-engine)
[![License](https://img.shields.io/badge/license-IECL--v1.0-red.svg)](LICENSE)

**Latest Release:** v2.2.0 - Self-Improving Search Loop | **Docker Image:** `anony45/intent-engine-api:latest`
